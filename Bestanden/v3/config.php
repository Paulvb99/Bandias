...
function showTxt(id) {
  ...
  <table width=50%>
    <tr><td class="subTitle"><b><center><?php echo $sitename; ?> is tijdelijk offline!</center></b></td></tr>
    <tr><td class="mainTxt">
<center>Er hebben zich problemen voorgedaan in onze database, excuses voor het ongemak!</center>
    </td></tr>
  </table>
</body>
