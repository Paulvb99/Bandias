...
?>
		...
		<div style="width:100%; height:25px; background:url('images/tab_info_bg.jpg') repeat-x; font-family:arial; font-size:12px; color:#2a190e;">
									<div id="tab1" style="float:left; height:26px; margin:0px; padding:0px; margin-left: 5px; background:url('images/tab_info_arrow.gif') bottom no-repeat; font-weight:bold;"><a href="#" onclick="openTab('drug_sell','tab1'); return false">Tabak verkopen</a></div>
												<div style="float:left; height:26px; margin:0px; padding:0px; margin-left: 5px;">|</div>
												<div id="tab2" style="float:left; height:26px; margin:0px; padding:0px; margin-left: 5px;"><a href="#" onclick="openTab('drug_index','tab2'); return false">Tabak koersen</a></div>
								</div>
		...
		<table cellpadding="4" cellspacing="0" width="100%" align="center"><tr><td>
			<div id="drug_sell">
		Behalve je tabak te koop zetten heb je ook de mogelijkheid deze te verkopen in cafe's, discotheken, op parkeerplaatsen en dergelijke. Hoeveel geld je per zakje / doosje ontvangt hangt af van wat de zogenaamde tabakkoers is in de stad. Deze kun je vinden op onder het tabblad "Tabak koersen"		<br /><br />
				...
				<td>
					<form method="POST">
						<table width="100%" cellpadding="2" cellspacing="2" class="mod_list">
															<tr class="top">
									<td><b>Pruimtabak Upgrade</b></td><td width="6%" align="center"><img src="images/icons_gif/pill.gif" alt="Tabak"></td><td>Bezit: <?echo$data->pruimtabak;?> zakjes</td>
								</tr>
								<tr class="top">
									<td>Verkopen:</td><td width="6%" align="center"><img src="images/icons_gif/pill_go.gif" alt="Tabak"></td><td><input type="text" name="tabak_1" size="5" value="0"> zakjes</td>
								</tr>
								...
								<tr height="5">
															...
															<tr class="top">
									<td><b>Van Nelle Upgrade</b></td><td width="6%" align="center"><img src="images/icons_gif/pill.gif" alt="Tabak"></td><td>Bezit: <?echo$data->vannelle;?> zakjes</td>
								</tr>
								<tr class="top">
									<td>Verkopen:</td><td width="6%" align="center"><img src="images/icons_gif/pill_go.gif" alt="Tabak"></td><td><input type="text" name="tabak_2" size="5" value="0"> zakjes</td>
								</tr>
								...
								<tr height="5">
															...
															<tr class="top">
									<td><b>Drum Upgrade</b></td><td width="6%" align="center"><img src="images/icons_gif/pill.gif" alt="Tabak"></td><td>Bezit: <?echo$data->drum;?> zakjes</td>
								</tr>
								<tr class="top">
									<td>Verkopen:</td><td width="6%" align="center"><img src="images/icons_gif/pill_go.gif" alt="Tabak"></td><td><input type="text" name="tabak_3" size="5" value="0"> zakjes</td>
								</tr>
								...
								<tr height="5">
															...
															<tr class="top">
									<td><b>L&M Upgrade</b></td><td width="6%" align="center"><img src="images/icons_gif/pill.gif" alt="Tabak"></td><td>Bezit: <?echo$data->lm;?> doosjes</td>
								</tr>
								<tr class="top">
									<td>Verkopen:</td><td width="6%" align="center"><img src="images/icons_gif/pill_go.gif" alt="Tabak"></td><td><input type="text" name="tabak_4" size="5" value="0"> doosjes</td>
								</tr>
								...
								<tr height="5">
															...
															<tr class="top">
									<td><b>Kent Upgrade</b></td><td width="6%" align="center"><img src="images/icons_gif/pill.gif" alt="Tabak"></td><td>Bezit: <?echo$data->kent;?> doosjes</td>
								</tr>
								<tr class="top">
									<td>Verkopen:</td><td width="6%" align="center"><img src="images/icons_gif/pill_go.gif" alt="Tabak"></td><td><input type="text" name="tabak_5" size="5" value="0"> doosjes</td>
								</tr>
								...
								<tr height="5">
															...
															<tr class="top">
									<td><b>Panter Upgrade</b></td><td width="6%" align="center"><img src="images/icons_gif/pill.gif" alt="Tabak"></td><td>Bezit: <?echo$data->panter;?> doosjes</td>
								</tr>
								<tr class="top">
									<td>Verkopen:</td><td width="6%" align="center"><img src="images/icons_gif/pill_go.gif" alt="Tabak"></td><td><input type="text" name="tabak_6" size="5" value="0"> doosjes</td>
								</tr>
