...
?>
	...
	<div style="font-size:17px; color:#1b1a17; margin-left:10px; padding-top:4px;">
		Goede kope auto's</div>
</div>

<div style="width:100%; height:auto; background:#c3b79d; font-family:arial; font-size:12px; color:#2a190e;">
	<div style="padding:5px; padding-bottom:10px;">Ben je nog maar een beginner? Hier staan de goed kope auto's</div>
</div>
...
<div style="width:100%; height:25px; background:url('images/tab_info_bg.jpg') repeat-x; font-family:arial; font-size:12px; color:#2a190e;">
  <div id="tab" style="float:left; height:26px; margin:0px; padding:0px; margin-left: 5px; background:url('images/tab_info_arrow.gif') bottom no-repeat; font-weight:bold;"><a href="index.php?a=mod_steal_cheap_cars">Goedkope</a></div>
