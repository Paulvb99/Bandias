...
?>
  ...
  <div id="contentHeader"><h2>Koop credits met iDeal</h2></div>
  	...
  	<p>U heeft het volgende bedrag gekozen:</p>         
         <p>
         <b><font color="blue">iDeal 25 EURO - 700 Call credits</font></b>
...
$description = "700 call credits $data->login";		// Description (will appear on receipt)
$amount = 2500;							// Amount in eurocents (e.g. 1000 means € 10,00)
