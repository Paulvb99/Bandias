...
<?if($_GET['f'] == ""){
if($data->inzet > 0){?><center><FONT color='red'><b>Je hebt nog een blackjack sessie!<BR>Door op begin te klikken, zul je geen geld verliezen en je sessie vernieuwen.</b></FONT></center><?}?>
$x = rand(0,999999);
?>
