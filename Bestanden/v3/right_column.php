...
?>
	...
	<table width=176px height=100% border=0px cellspacing=0px cellpadding=0px style="background-color:#160904;">
		<tr>
		<td align=center width=176 height=21px><a href="index.php?a=mod_other_missions"><img src="images/btn_missies_stop.gif" border="0"></a> <a href="forum.php"><img src="images/btn_forum.jpg" border="0"></a></td>
		</tr>
		<tr>

		<td align=center width=176 height=34 ><div id="welkom">Welkom <a href="index.php?a=profile&x=<?echo$data->id;?>"><?echo$data->login;?></a>!</div></td>
		</tr>

		<tr>
		<td align=left width=176 height=150 style="background: url(images/homefinal_sliced_07.jpg) top no-repeat; background-color:#fbf1ef;">
		<center>
...
$rank = $rank[$data->rank];
?>
					<div id="rang"><?echo$data->rankvord;?>% <?echo$rank;?></div><div id="div_progress"><img src="images/power.jpg" height="15px" width="<?=$data->rankvord?>"></div>
						</td>
					</tr>
				</table>
					</center>
		...
		<div id="content_menu_2">
			...
			<div id="menulist_crimi">
                <div class="menu-item"><img src="images/arrow.jpg"><a href="index.php?a=misdaadmenu">Misdaad menu</a><img src="images/seperator.jpg" class="sep"></div>
				<div class="menu-item"><img src="images/arrow.jpg"><a href="index.php?a=drugsmenu">Drugs / Drank</a><img src="images/seperator.jpg" class="sep"></div>
				<div class="menu-item"><img src="images/arrow.jpg"><a href="index.php?a=automenu">Auto menu</a><img src="images/seperator.jpg" class="sep"></div>
				<div class="menu-item"><img src="images/arrow.jpg"><a href="index.php?a=scootermenu">Scootermenu <font color="red">NIEUW!</font></a><img src="images/seperator.jpg" class="sep"></div>
				<div class="menu-item"><img src="images/arrow.jpg"><a href="index.php?a=work">Werken</a></div><img src="images/seperator.jpg" class="sep">
                <div class="menu-item"><img src="images/arrow.jpg"><a href="index.php?a=goudjatten">Goud jatten</a><img src="images/seperator.jpg" class="sep"></div>
<br>
				</div>
			...
			<div id="menulist_loc">
				...
				<div class="menu-item"><img src="images/arrow.jpg"><a href="index.php?a=woningopties">Woning menu <font color="red">NIEUW!</font></a><img src="images/seperator.jpg" class="sep"></div>
                ...
                <div class="menu-item"><img src="images/arrow.jpg"><a href="index.php?a=goud_smit">Goud smit</a><img src="images/seperator.jpg" class="sep"></div>
<?php
if($data2->extraatje != "Ja" && $data2->mac != "Ja" && $data2->killershop != "Ja"){
}else {
				echo '<div class="menu-item"><img src="images/arrow.jpg"><a href="index.php?a=overigeopties">Overige opties</a><img src="images/seperator.jpg" class="sep"></div>'; } ?>
				...
				<div class="menu-item"><img src="images/arrow.jpg"><a href="index.php?a=reizen">Reizen</a><img src="images/seperator.jpg" class="sep"></div>
			</div>
...
?>
			<div class="menu-item"><img src="images/arrow.jpg"><a href="index.php?a=list">Gangsters: <?echo$registered;?></a><img src="images/seperator.jpg" class="sep"></div>
			<div class="menu-item"><img src="images/arrow.jpg"><a href="index.php?a=onlineleden">Online Gangsters: <?=$online?></a><img src="images/seperator.jpg" class="sep"></div>
...
urchinTracker();
		...
		</script><script type="text/javascript" src="$sitelink/lib/tinymce/langs/en.js" onload="tinymce.dom.ScriptLoader._onLoad(this,'$sitelink/lib/tinymce/langs/en.js',0);"></script><script type="text/javascript" src="$sitelink/lib/tinymce/themes/advanced/editor_template.js" onload="tinymce.dom.ScriptLoader._onLoad(this,'$sitelink/lib/tinymce/themes/advanced/editor_template.js',1);"></script><script type="text/javascript" src="$sitelink/lib/tinymce/themes/advanced/langs/en.js"></script><script type="text/javascript" src="$sitelink/lib/tinymce/plugins/emotions/editor_plugin.js" onload="tinymce.dom.ScriptLoader._onLoad(this,'$sitelink/lib/tinymce/plugins/emotions/editor_plugin.js',2);"></script><script type="text/javascript" src="$sitelink/lib/tinymce/plugins/fullscreen/editor_plugin.js" onload="tinymce.dom.ScriptLoader._onLoad(this,'$sitelink/lib/tinymce/plugins/fullscreen/editor_plugin.js',3);"></script>
</td></tr></tbody></table></div><div align="center">
<div style="width: 1000px; height: 50px;">
<p style="text-align: center; color: rgb(202, 202, 202);">Alle rechten voorbehouden, <?php echo $sitename ?></p>
