...
?>
				...
				<tr>
					...
					<td width="18px" align="center"><img src='images/icons_gif/autowaarde.png'></td>
					<td>Waarde: <b>&euro; <?echo$waarde;?></b></td>
				</tr>
				<tr>
					<td width="18px" align="center"><img src='images/icons_gif/autoschade.png'></td>
					<td>Schade: <b><?echo$list->schade;?> %</b></td>
				</tr>
				<tr>
					<td width="18px" align="center"><a href="index.php?a=garage&mode=repair&x=<?echo$list->id;?>"><img src="images/icons_gif/autorepareren.png" border="0" alt="Repareer!"></a></td>
					<td><b><a href="index.php?a=garage&mode=repair&x=<?echo$list->id;?>">Repareer</a></b></td>
				</tr>
				<tr>
					<td width="18px" align="center"><a href="index.php?a=garage&mode=sell&x=<?echo$list->id;?>"><img src="images/icons_gif/autoverkopen.png" border="0" alt="Verkoop!"></a></td>
